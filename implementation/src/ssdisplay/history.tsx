...
import "./a_ss.css";
import VersionHistoryDetails from "./version"; // Import the new component
  ...
  return (
    <div className="bg-nav grid row col-12">
      ...
      {/* <div className="version-history-list">
        {props.history.map((version: string, index: string) => (
          <VersionHistoryDetails key={index} version={version} />
        ))}
      </div> */}
    </div>
  );
